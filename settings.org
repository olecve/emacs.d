...
#+STARTUP: overview
#+PROPERTY: header-args:emacs-lisp :mkdirp yes :shebang ";; -*- lexical-binding: t; -*-"
...
(setq org-agenda-files
    (cond ((eq system-type 'darwin)
           (directory-files-recursively "~/projects/org" ".org$" nil
                                         (lambda (dir)
                                           (let ((name (file-name-nondirectory dir)))
                                             (not (or (string-prefix-p "." name)
                                                      (string-equal name "archives")))))))
          ((eq system-type 'windows-nt)
           (append (directory-files-recursively (expand-file-name "OneDrive/org/todo" (getenv "USERPROFILE")) ".org$")
                   (directory-files-recursively (expand-file-name "OneDrive/org/areas" (getenv "USERPROFILE")) ".org$")))))
