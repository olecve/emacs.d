...
** Theme
   ...
   - good light options: base16-atelier-cave-light, base16-atelier-plateau-light, base16-atelier-savanna-light
   - good dark options: base16-eighties, base16-flat

#+BEGIN_SRC emacs-lisp
(setq light-theme 'base16-atelier-savanna-light)
...
(setq org-todo-keywords
      '((sequence "TODO(t)" "|" "DONE(d)")
        (sequence "BLOCK(b)" "|" "CANCELLED(c)" "|" "HOLD(h)")))
